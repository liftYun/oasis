...
export const registerMessages: Record<'kor' | 'eng', RegisterTexts> = {
  kor: {
    ...
    errorDuplicate: '이미 사용 중인 닉네임입니다.',
    errorCheckFail: '닉네임 확인 중 오류가 발생했습니다.',
    successNickname: '사용 가능한 닉네임입니다',
    errorImage: '이미지 파일만 업로드할 수 있습니다.',
    errorPdf: '이미지 또는 PDF만 업로드할 수 있어요.',
    limtedPdf: '최대 10MB까지 업로드할 수 있어요.',
    errorProfile: '프로필 이미지 업로드 중 오류가 발생했습니다.',
  },
  eng: {
    ...
    errorDuplicate: 'This nickname is already in use.',
    errorCheckFail: 'An error checking the nickname.',
    successNickname: 'This nickname is available.',
    errorImage: 'Only image files can be uploaded.',
    errorPdf: 'Only images or PDFs can be uploaded.',
    limtedPdf: 'You can upload up to 10MB.',
    errorProfile: 'Error uploading profile image.',
  },
};
